...
class MarcheDetaille(models.Model):
    ...
    resp_marche = models.ManyToManyField('authentification.Profile', related_name='marches_resp')
    ...
    nom_client = models.ManyToManyField(NomClient, related_name='marches_client')
    # solution ajoutée
    solution = models.ForeignKey(Solution, on_delete=models.PROTECT, null=True, blank=True)
