...
def export_cartes_xlsx(request, marche_detaille_id):
    ...
    for carte in cartes:
        ...
        date_retour = carte.date_retour.isoformat() if carte.date_retour else ""
        date_livraison = carte.date_livraison.isoformat() if carte.date_livraison else ""
        date_maj = timezone.make_naive(carte.date_maj).isoformat() if carte.date_maj else ""
