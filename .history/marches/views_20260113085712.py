...
def export_cartes_xlsx(request, marche_detaille_id):
    ...
    # Création du classeur et de la feuille active
    wb = Workbook()
    ws = wb.active
    ...
    for carte in cartes:
        # Gestion des dates
        date_livraison = carte.date_livraison
        date_maj = timezone.make_naive(carte.date_maj) if hasattr(carte.date_maj, 'tzinfo') else carte.date_maj
