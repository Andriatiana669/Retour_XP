...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function applyFilters() {
    const field   = searchFieldSel.value;           // champ choisi
  ...
  // on écoute les 4 contrôles
  [searchFieldSel, searchInp, dateInp, sortSel].forEach(el => el.addEventListener('input', applyFilters));
